...
-- *******       **********      ****************            ******************
-- 01            14-04-2023      Hamza Alchbli               New
-- **********************************************************************************/

-- Check if the database exists
DROP DATABASE IF EXISTS `rijschool-mvc`;

-- Create a new Database
CREATE DATABASE IF NOT EXISTS `rijschool-mvc`;

-- Use database rijschool-mvc
Use `rijschool-mvc`;
...
VALUES
    ...
    ,('Mohammd', 'El', 'Yassidi', '06-34291234', '2010-06-14', '*****', 1, NULL, SYSDATE(6), SYSDATE(6));
...
(
    ...
    ,CONSTRAINT FK_VoertuigInstructeur_Voertuig_Id FOREIGN KEY (VoertuigId) REFERENCES Voertuig(Id)
    ,CONSTRAINT FK_VoertuigInstructeur_Instructeur_Id FOREIGN KEY (InstructeurId) REFERENCES Instructeur(Id)
) ENGINE=InnoDB;
